            ...
            <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div v-for="booking in bookings" :key="booking.id" class="bg-white shadow-md rounded-lg p-6">
                    <div class="mb-4 h-48">
                        ...
                        )?.image_path}`" alt="Primary Vehicle Image" class="w-full h-full object-cover rounded-md" />
                    </div>
                    <div>
                        ...
                        <span class="inline-block bg-green-100 text-green-800 px-2 py-1 rounded mt-2">
                            Confirmed
                        </span>
                    </div>
                </div>
